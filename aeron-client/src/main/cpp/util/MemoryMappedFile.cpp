...
MemoryMappedFile::ptr_t MemoryMappedFile::createNew(const char *filename, uint64_t offset, size_t length)
{
    aeron_mapped_file_t mapped_file;
    if (aeron_map_new_file(&mapped_file, filename, length, offset, true) < 0)
    {
