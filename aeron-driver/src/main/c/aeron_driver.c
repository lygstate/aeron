...
int aeron_driver_create_cnc_file(aeron_driver_t *driver)
{
    ...
    if (aeron_map_new_file(&driver->context->cnc_map, buffer, cnc_file_length, 0, true) < 0)
    {
...
int aeron_driver_create_loss_report_file(aeron_driver_t *driver)
{
    ...
    if (aeron_map_new_file(&driver->context->loss_report, buffer, loss_report_file_length, 0, true) < 0)
    {
