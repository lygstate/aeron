...
Settings parseCmdLine(CommandOptionParser &cp, int argc, char **argv)
{
    ...
    s.numberOfMessages = cp.getOption(optMessages).getParamAsLong(0, 0, LLONG_MAX, s.numberOfMessages);
    ...
    s.numberOfWarmupMessages = cp.getOption(optWarmupMessages).getParamAsLong(0, 0, LLONG_MAX, s.numberOfWarmupMessages);
